    ...
    public partial class FormMotoboy : Form
    {
        ...
        private void CarregarMotoboys()
        {
            try
            {
                ...
                var dt = repo.GetAllAsync().GetAwaiter().GetResult();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Erro ao carregar motoboys. Veja logs.");
            }
        }
        ...
        private async void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var repo = new DevBurguer.Data.MotoboyRepository();
                await repo.InsertAsync(txtNome.Text, txtEndereco.Text, txtTelefone1.Text, txtTelefone2.Text, txtCPF.Text).ConfigureAwait(false);
        ...
        private async void btnAtualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var repo = new DevBurguer.Data.MotoboyRepository();
                await repo.UpdateAsync(id, txtNome.Text, txtEndereco.Text, txtTelefone1.Text, txtTelefone2.Text, txtCPF.Text).ConfigureAwait(false);
